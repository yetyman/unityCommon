...
public abstract class DictionaryDrawer<TK, TV> : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        foreach (var item in _Dictionary)
        {
            ...
            keyRect.width -= 4;
            EditorGUI.BeginChangeCheck();
            var newKey = MakeField(keyRect, typeof(TK), key);
            if (EditorGUI.EndChangeCheck())
            {
                try
                {
            ...
            EditorGUI.BeginChangeCheck();
            value = MakeField(valueRect, typeof(TV), value);
            if (EditorGUI.EndChangeCheck())
            {
    ...
    private static T MakeField<T>(Rect rect, Type type, T value)
    {
...
[CustomPropertyDrawer(typeof(TextBoxControllerDictionary))]
public class MyDictionaryDrawer3 : DictionaryDrawer<string, MonoBehaviour> { }

[CustomPropertyDrawer(typeof(ButtonDictionary))]
public class MyDictionaryDrawer4 : DictionaryDrawer<string, Button> { }

[CustomPropertyDrawer(typeof(SpriteDictionary))]
public class MyDictionaryDrawer5 : DictionaryDrawer<string, Sprite> { }

[CustomPropertyDrawer(typeof(ObjectDictionary))]
public class MyDictionaryDrawer6 : DictionaryDrawer<string, object> { }

[CustomPropertyDrawer(typeof(UITextDictionary))]
public class MyDictionaryDrawer7 : DictionaryDrawer<string, UITextElement> { }

[CustomPropertyDrawer(typeof(IndexToIndexDictionary))]
public class MyDictionaryDrawer8 : DictionaryDrawer<int, int> { }
